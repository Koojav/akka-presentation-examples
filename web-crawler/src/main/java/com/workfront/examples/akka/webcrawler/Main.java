...
public class Main
{
    public static void main(String[] args) throws IOException, InterruptedException
    {
        ...
        final ActorRef heroesStr = actorSystem.actorOf(HeroesHttpDataRetrievalActor.props(), "heroesStr");
        final ActorRef heroesInt = actorSystem.actorOf(HeroesHttpDataRetrievalActor.props(), "heroesInt");
        final ActorRef heroesAgi = actorSystem.actorOf(HeroesHttpDataRetrievalActor.props(), "heroesAgi");
        ...
        for (int i = 0; i < 5; i++)
        {
            final ActorRef heroProcessor = actorSystem.actorOf(HeroProcessorActor.props(), "heroRowProcessor" + i);
